...
import { Save, QrCode, FileImage, FileCode, Sparkles } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-8">
        ...
        >
          <div className="glass-card p-8">
            ...
            >
              <label htmlFor="qr-text" className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">
                Enter Text or URL
              </label>
              <textarea
                id="qr-text"
